const zhCN = {
  ...
  transferUploadHint: '上传会先写入远端 /tmp/fileterm-upload.*，成功后再 mv 到目标目录；当前不支持断点续传。',
  inProgress: '进行中',
  completed: '已完成/终止',
  all: '全部',
  stop: '终止',
...
const enUS: typeof zhCN = {
  ...
  transferUploadHint: 'Uploads are written to a remote /tmp/fileterm-upload.* path first, then moved into place; resumable uploads are not supported yet.',
